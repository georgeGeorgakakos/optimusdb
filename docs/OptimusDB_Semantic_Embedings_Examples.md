...
"count": 3,
"results": [
{"doc_id": "asset_solar_001", "score": 0.91, "store_name": "energy_assets", "source_node": "<node1_peer_id>"},
    {"doc_id": "asset_wind_003",  "score": 0.88, "store_name": "energy_assets", "source_node": "<node3_peer_id>"},
        {"doc_id": "asset_hydro_002", "score": 0.85, "store_name": "energy_assets", "source_node": "<node2_peer_id>"}
            ]
            }
            ```
            ...
            **Expected result:** All three nodes return the same count, confirming symmetric
            ...
            -d '{
            "doc_id": "asset_solar_001",
            "ipfs_cid": "<CID_FROM_VEC_META_ABOVE>"
                }'
                ```
                ...
                **Expected result:**
                ...
                "header": [{"key": "Content-Type", "value": "application/json"}],
                "body": {"mode": "raw", "raw": "{\"doc_id\": \"asset_solar_001\", \"ipfs_cid\": \"<CID_FROM_VEC_META>\"}"}
                    }
                    },
                    {
                    "name": "7. List Peers",
